...
<div class="login-page-container">
    <div class="glass-card login-glass-card">
        ...
        <div class="auth-header">
            ...
            <h3 class="glass-title-green mb-1">User Login</h3>
            <p class="text-muted small">Sign in to access fresh organic products</p>
        </div>
        ...
        <form method="POST" action="{{ route('user.login.submit') }}">
            ...
            <p class="text-center text-muted small mb-0">
                New User? <a href="{{ route('user.register') }}" class="auth-link">Create an Account</a>
            </p>
